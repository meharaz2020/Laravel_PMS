                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="box box-primary">
                            ...
                            <!-- /.box-header -->
                            <!-- form start -->
                            <form role="form" method="POST" action="{{ url('save_prescription') }}">
                                @csrf
                                <div class="box-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <input name="visit_date" id="visit_date" class="form-control" />
                                        </div>
                                        <div class="col-md-2">
                                            <label for="">Bp</label>
                                            <input name="bp" id="bp" class="form-control" />


                                        </div>
                                        <div class="col-md-2">
                                            <label for="">weight</label>
                                            <input name="patient_weight" id="patient_weight" class="form-control" />


                                        </div>
                                        <div class="col-md-2">
                                            <label for="">Last Visit date</label>
                                            <input name="next_visit_date" id="last_visit_date" class="form-control" />
                                        </div>
                                    </div>
